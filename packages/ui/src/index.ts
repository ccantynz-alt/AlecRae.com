...
export { ComposeEditor, type ComposeEditorProps, type ComposeData, type AISuggestion, type CalendarSlotRequestFn, type ComposeMailboxOption } from "./composites/compose-editor";
...
// Types live in spatial-types.ts so they can be re-exported without pulling
// the R3F-dependent components into the typecheck program.
export type {
