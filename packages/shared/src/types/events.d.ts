...
export type EmailEventType = "email.queued" | "email.sent" | "email.delivered" | "email.bounced" | "email.deferred" | "email.dropped" | "email.failed" | "email.opened" | "email.clicked" | "email.unsubscribed" | "email.complained" | "domain.verified" | "domain.failed";
/** Bounce classification. */
export type BounceType = "hard" | "soft";
/** Bounce category for diagnostics. */
export type BounceCategory = "unknown_user" | "mailbox_full" | "domain_not_found" | "policy_rejection" | "spam_block" | "rate_limited" | "protocol_error" | "content_rejected" | "authentication_failed" | "other";
