...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for the AlecRae AI-native email infrastructure platform.",
};
  ...
  return (
    <Box className="max-w-4xl mx-auto">
      ...
      <Section number="1" title="Acceptance of Terms">
        <Text>By accessing or using the AlecRae platform, API, website, or any associated services (collectively, the &quot;Service&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you are using the Service on behalf of an organization, you represent and warrant that you have authority to bind that organization to these Terms, and &quot;you&quot; refers to both you individually and the organization.</Text>
      ...
      <Section number="2" title="Definitions">
        <Sub label="&quot;Service&quot;">The AlecRae email infrastructure platform, including all web applications, APIs, SMTP/JMAP servers, AI features, admin dashboards, SDKs, and documentation.</Sub>
        ...
        <Sub label="&quot;API&quot;">The Application Programming Interface provided by AlecRae for programmatic access to the Service.</Sub>
      ...
      <Section number="4" title="Description of Services">
        <Text>AlecRae provides an AI-native email infrastructure platform that includes:</Text>
      ...
      <Section number="5" title="AI Services and Data Processing">
        ...
        <Sub label="(c) No Human Review.">Email content is processed exclusively by automated AI systems. No AlecRae employee or contractor reviews your email content. Human review occurs only when (i) you contact support and voluntarily share content, or (ii) we are compelled by valid legal process.</Sub>
      ...
      <Section number="7" title="API Terms">
        ...
        <Sub label="(c) Fair Use.">API usage must be reasonable and consistent with the intended purpose of the Service. AlecRae reserves the right to throttle or suspend API access that places disproportionate load on infrastructure.</Sub>
        <Sub label="(d) Versioning.">AlecRae may introduce new API versions and deprecate older versions with a minimum of 90 days&apos; notice. Deprecated API versions will continue to function during the notice period.</Sub>
      ...
      <Section number="8" title="Sending Limits and Anti-Spam Obligations">
        ...
        <Sub label="(e)">AlecRae may impose sending limits, throttle delivery, or suspend your account if your sending patterns indicate spam or abuse, or if your bounce or complaint rates exceed platform thresholds.</Sub>
      </Section>
      ...
      <Section number="9" title="Domain Verification">
        ...
        <Text>You must maintain valid SPF, DKIM, and DMARC records for all verified domains. AlecRae may automatically configure these records on your behalf if you delegate DNS management to us.</Text>
        <Text>AlecRae reserves the right to suspend sending from domains that fail verification, have expired verification, or lack proper authentication records.</Text>
      </Section>
      ...
      <Section number="10" title="Payment Terms">
        ...
        <Sub label="(b) Price Changes.">AlecRae may change subscription prices with 30 days&apos; advance notice. Price changes take effect at the start of your next billing period. If you do not agree to a price change, you may cancel before the new price takes effect.</Sub>
        ...
        <Sub label="(d) Taxes.">Prices are exclusive of applicable taxes. You are responsible for all taxes, levies, and duties imposed by taxing authorities, excluding taxes based on AlecRae&apos;s net income.</Sub>
      ...
      <Section number="11" title="Intellectual Property">
        <Sub label="(a) Platform IP.">AlecRae and its licensors retain all right, title, and interest in the Service, including all software, AI models, algorithms, designs, documentation, trade names, trademarks, and patents. Nothing in these Terms grants you any right in the foregoing except the limited right to use the Service as permitted herein.</Sub>
        <Sub label="(b) Your Content.">As stated in Section 6, you retain ownership of your Content.</Sub>
        <Sub label="(c) AI-Generated Output.">You own the output generated by AI features for your use (e.g., drafted emails). However, AlecRae retains all rights to the underlying AI models, algorithms, and training methodologies used to generate such output. Similar or identical output may be generated for other users.</Sub>
        <Sub label="(d) Feedback.">Any feedback, suggestions, or ideas you provide about the Service may be used by AlecRae without obligation or compensation to you.</Sub>
      ...
      <Section number="13" title="Indemnification">
        <Text>You agree to indemnify, defend, and hold harmless AlecRae, its officers, directors, employees, agents, and affiliates from and against any and all claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys&apos; fees) arising from or related to:</Text>
      ...
      <Section number="14" title="Warranty Disclaimer">
        ...
        <Sub label="(a)">AlecRae does not warrant that the Service will be uninterrupted, error-free, secure, or free from viruses or other harmful components.</Sub>
        <Sub label="(b)">AlecRae does not warrant the accuracy, reliability, or completeness of any AI classifications, recommendations, or generated content.</Sub>
        <Sub label="(c)">AlecRae does not warrant any specific level of email deliverability, inbox placement, or sender reputation score.</Sub>
        <Sub label="(d)">AlecRae does not warrant that the Service will meet your specific requirements or expectations.</Sub>
      </Section>
      ...
      <Section number="18" title="Data Portability">
        ...
        <Text>AI-derived data (priority scores, sentiment analysis, relationship graphs, writing style models) is not exportable, as it constitutes AlecRae&apos;s proprietary processing output and is generated by our proprietary AI models.</Text>
      </Section>

      <Section number="19" title="Modifications to Terms">
        <Text>AlecRae may modify these Terms at any time. For material changes, we will provide at least 30 days&apos; advance notice via email to the address associated with your account and through a prominent notice on the Service. Material changes that expand our rights to use your Content or narrow your rights will require your affirmative consent.</Text>
      ...
      <Section number="23" title="Third-Party Services">
        <Text>The Service may integrate with or link to third-party services (payment processors, DNS providers, analytics tools). AlecRae is not responsible for the availability, accuracy, or content of third-party services, and your use of them is subject to their respective terms and privacy policies. AlecRae makes no warranties regarding third-party services.</Text>
      </Section>
      ...
      <Section number="25" title="Entire Agreement">
        <Text>These Terms, together with the Privacy Policy, Acceptable Use Policy, Data Processing Agreement, and Service Level Agreement, constitute the entire agreement between you and AlecRae regarding the Service. These Terms supersede all prior agreements, understandings, and communications, whether written or oral, regarding the subject matter herein.</Text>
