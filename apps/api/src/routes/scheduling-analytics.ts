  ...
  async (c) => {
    ...
    return c.json({
      data: {
        ...
        hourlyDistribution: engagement.openHourDistribution,
        dailyDistribution: engagement.openDayDistribution,
        bestHour: engagement.peakOpenHour,
        bestDay: engagement.peakOpenDay,
        lastEngagedAt: engagement.lastInteractionAt?.toISOString() ?? null,
